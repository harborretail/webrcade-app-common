...
const locGenesis = isDev() ? `http://localhost:3500/play/app/genesis/index.html` : 'app/genesis/';
const locSms = locGenesis;
const locRetroGenesis = isDev() ? `http://localhost:3500/play/app/retro-genesis/index.html` : 'app/retro-genesis/';
const locRetroPceFast = isDev() ? `http://localhost:3500/play/app/retro-pce-fast/index.html` : 'app/retro-pce-fast/';
const locPsx = isDev() ? `http://${localIp}:3099` : 'app/psx/';
const loc7800 = isDev() ? `http://${localIp}:3020` : 'app/7800/';
const locNes = isDev() ? `http://localhost:3500/play/app/nes/index.html` : 'app/nes/';
const locDoom = isDev() ? `http://${localIp}:3040` : 'app/doom/';
const loc2600 = isDev() ? `http://${localIp}:3050` : 'app/2600/';
const locSnes = isDev() ? `http://localhost:3500/play/app/snes/index.html` : 'app/snes/';
const locN64 = isDev() ? `http://localhost:3500/play/app/n64/index.html` : 'app/n64/';
